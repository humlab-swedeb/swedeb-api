...
Horizontal scaling across multiple API containers or replicas is intentionally excluded from this definition of done and is covered by `docs/change_requests/MULTIUSER_PHASE3_MULTI_CONTAINER_SCALING.md`.

*** Add File: /home/roger/source/swedeb/swedeb-api/docs/change_requests/MULTIUSER_PHASE3_MULTI_CONTAINER_SCALING.md

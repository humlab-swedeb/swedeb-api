...
class TestConfigValue:
    ...
    def test_configvalue_with_after_callback(self):
        ...
        ConfigStore.configure_context(source={"number": 10}, env_prefix=None)
    ...
    def test_configvalue_resolve_from_store(self):
        ...
        ConfigStore.configure_context(source={"test": {"value": "result"}}, env_prefix=None)
    ...
    def test_configvalue_resolve_returns_default(self):
        ...
        ConfigStore.configure_context(source={}, env_prefix=None)
    ...
    def test_configvalue_value_property(self):
        ...
        ConfigStore.configure_context(source={"prop": "value"}, env_prefix=None)
...
class TestConfigStore:
    ...
    def test_configstore_config_with_context_arg(self):
        ...
        ConfigStore.configure_context(context="ctx1", source=cfg1, env_prefix=None)
        ConfigStore.configure_context(context="ctx2", source=cfg2, env_prefix=None, switch_to_context=False)
    ...
    def test_configstore_resolve_non_configvalue(self):
        ...
        assert ConfigStore.resolve("plain_value") == "plain_value"
        assert ConfigStore.resolve(42) == 42

    def test_configstore_resolve_configvalue(self):
        """Test ConfigStore.resolve resolves ConfigValue by calling its resolve method."""
        ConfigStore.configure_context(source={"test": "result"}, env_prefix=None)
    ...
    def test_configstore_configure_context_from_config(self):
        ...
        cfg = Config(data={"test": "data"})
        result = ConfigStore.configure_context(source=cfg, env_prefix=None)
    ...
    def test_configstore_configure_context_switches_context(self):
        ...
        ConfigStore.configure_context(context="new_ctx", source={"key": "val"}, env_prefix=None)
    ...
    def test_configstore_configure_context_raises_without_source(self):
        ...
        with pytest.raises(ValueError, match="undefined, cannot initialize"):
            ConfigStore.configure_context(context="undefined_ctx", source=None, env_prefix=None)
    ...
    def test_configstore_configure_context_reuses_existing(self):
        ...
        ConfigStore.configure_context(context="reuse", source=cfg, env_prefix=None, switch_to_context=False)
        result = ConfigStore.configure_context(context="reuse", source=None, env_prefix=None, switch_to_context=False)
        assert result is cfg
...
class TestResolveArguments:
    ...
    def test_resolve_arguments_resolves_args(self):
        ...
        ConfigStore.configure_context(source={"val": 10}, env_prefix=None)
    ...
    def test_resolve_arguments_resolves_kwargs(self):
        ...
        ConfigStore.configure_context(source={"val": 20}, env_prefix=None)
        cv = ConfigValue(key="val")
    ...
    def test_resolve_arguments_resolves_defaults(self):
        ...
        ConfigStore.configure_context(source={"default_val": 42}, env_prefix=None)

"""Unit tests for api_swedeb.api.utils.utility module."""

import numpy as np
import pandas as pd
import pytest

from api_swedeb.api.utils.utility import get_filtered_speakers_improved


class TestGetFilteredSpeakersImproved:
    """Test suite for get_filtered_speakers_improved function."""
    ...
    def test_empty_dataframe_returns_empty(self, sample_person_party, sample_doc_index):
        ...
        df = pd.DataFrame()
        result = get_filtered_speakers_improved(sample_person_party, sample_doc_index, {"party_id": [1]}, df)
        assert result.empty
    ...
    def test_empty_selection_dict_returns_original(self, sample_person_party, sample_doc_index, sample_df):
        ...
        result = get_filtered_speakers_improved(sample_person_party, sample_doc_index, {}, sample_df)
    ...
    def test_none_selection_dict_returns_original(self, sample_person_party, sample_doc_index, sample_df):
        ...
        result = get_filtered_speakers_improved(
    ...
    def test_filter_by_party_id(self, sample_person_party, sample_doc_index, sample_df):
        ...
        result = get_filtered_speakers_improved(sample_person_party, sample_doc_index, {"party_id": [1]}, sample_df)
    ...
    def test_filter_by_party_id_with_none_person_party(self, sample_doc_index, sample_df):
        ...
        result = get_filtered_speakers_improved(None, sample_doc_index, {"party_id": [1]}, sample_df)
        assert result.empty
    ...
    def test_filter_converts_various_types_to_list(self, sample_person_party, sample_doc_index, sample_df):
        ...
        # Scalar
        result1 = get_filtered_speakers_improved(
            sample_person_party, sample_doc_index, {"gender_id": 1}, sample_df
        )
        assert len(result1) == 3

        # List
        result2 = get_filtered_speakers_improved(
            sample_person_party, sample_doc_index, {"gender_id": [1]}, sample_df
        )
        pd.testing.assert_frame_equal(result1, result2)

        # Tuple
        result3 = get_filtered_speakers_improved(
            sample_person_party, sample_doc_index, {"gender_id": (1,)}, sample_df
        )
        pd.testing.assert_frame_equal(result1, result3)

        # Set
        result4 = get_filtered_speakers_improved(
            sample_person_party, sample_doc_index, {"gender_id": {1}}, sample_df
        )
        pd.testing.assert_frame_equal(result1, result4)

        # NumPy array
        result5 = get_filtered_speakers_improved(
            sample_person_party, sample_doc_index, {"gender_id": np.array([1])}, sample_df
        )
        pd.testing.assert_frame_equal(result1, result5)

        # Pandas Series
        result6 = get_filtered_speakers_improved(
    ...
    def test_handles_integer_person_id_dtype(self, sample_person_party, sample_doc_index):
        ...
        result = get_filtered_speakers_improved(person_party, sample_doc_index, {"party_id": [1]}, df)
